...
**Q2.** Which of the following is responsible for the STRUCTURE of a web page?
...
**Q3.** What does a browser do?

- A) Stores website files
- B) Writes HTML code
- C) Reads and displays HTML files ✅
- D) Creates servers

---

**Q4.** What protocol is used for communication between browser and server?
...
**Q5.** Which file is typically the default homepage of a website?
...
**Q7.** Which part of the HTML tag signals the end of an element?
...
**Q8.** Which of the following is a self-closing (void) tag?
...
**Q9.** In the house analogy, what does CSS represent?

- A) Bricks and walls
- B) Electricity and plumbing
- C) Paint and decoration ✅
- D) Foundation

---

**Q10.** What does the `<title>` tag do?
...
> The **Internet** is the global network of connected computers. The **Web (WWW)** is a collection of websites and web pages that run on top of the Internet. The Internet is the infrastructure; the Web is a service that uses it.

---

**Q2. Explain the request-response cycle in simple terms.**

> When you type a URL in your browser, the browser sends a **request** to the server asking for the web page. The server finds the HTML file and sends it back as a **response**. The browser then reads the HTML and displays the page on your screen.

---

**Q3. Why is HTML not considered a programming language?**

> HTML is a **markup language**, not a programming language. It has no logic, no conditions (if/else), no loops, and no variables. It only **describes the structure** of content — it tells the browser *what* things are, not *how to think or decide*.

---

**Q4. Write the basic structure of an HTML document and label each part.**
...
**Q5. What is the difference between an opening tag, closing tag, and a self-closing tag? Give one example of each.**

> - **Opening tag:** Starts an element → `<p>`
> - **Closing tag:** Ends an element (has `/`) → `</p>`
> - **Self-closing tag:** Has no closing tag and no content → `<br>`
>
> Example: `<p>Hello</p>` uses opening and closing tags. `<br>` is self-closing.
