...
**Q1.** Which HTML tag creates an unordered (bulleted) list?
...
**Q2.** What does the `href` attribute in `<a>` stand for?

- A) Hyper Reference Format
- B) Hypertext Reference ✅
- C) HTML Reference File
- D) Hyper Resource Finder

---

**Q3.** Which URL type should be used for linking to pages within your OWN website?
...
**Q4.** What does `target="_blank"` do?

- A) Opens the link in the same tab
- B) Downloads the file
- C) Opens the link in a new tab ✅
- D) Deletes the current page

---

**Q5.** Which tag pair is used for description lists?
...
**Q6.** How do you link to a section with `id="features"` on the same page?

- A) `<a href="features">`
- B) `<a href="#features">` ✅
- C) `<a href="id:features">`
- D) `<a href="@features">`

---

**Q7.** What does `../` mean in a relative URL path?

- A) Go into a subfolder
- B) Stay in the current folder
- C) Go up one folder level ✅
- D) Go to the root folder

---

**Q8.** Where should a nested list be placed?

- A) Directly inside `<ul>`
- B) Inside an `<li>` element ✅
- C) Inside `<p>`
- D) After `</ul>`

---

**Q9.** Which of the following is the BEST link text?

- A) `<a href="about.html">Click here</a>`
- B) `<a href="about.html">Here</a>`
- C) `<a href="about.html">Learn about our company</a>` ✅
- D) `<a href="about.html">Link</a>`

---

**Q10.** Which attribute should you always add when using `target="_blank"`?
...
**Q1. What is the difference between `<ul>`, `<ol>`, and `<dl>`? Give one use case for each.**

> - **`<ul>` (Unordered List):** Displays items with bullet points where order doesn't matter.
>   - *Use case:* A list of skills: HTML, CSS, JavaScript
>
> - **`<ol>` (Ordered List):** Displays items with numbers where sequence matters.
>   - *Use case:* Step-by-step recipe instructions
>
> - **`<dl>` (Description List):** Pairs terms with their descriptions/definitions.
>   - *Use case:* A glossary defining HTML, CSS, and JavaScript

---

**Q2. Explain the difference between absolute and relative URLs with examples.**

> **Absolute URL** includes the full address with protocol and domain. It's used for linking to **external websites**.
> ```html
> <a href="https://www.google.com">Google</a>
> ```
>
> **Relative URL** is a path relative to the current file's location. It's used for linking to **pages within your own website**.
> ```html
> <a href="about.html">About Us</a>
> <a href="../index.html">Back to Home</a>
> ```
>
> Absolute URLs always point to the same place regardless of where your file is. Relative URLs depend on the current file's location.

---

**Q3. How do you create a link that jumps to a specific section on the same page? Write the complete code for both the link and the target.**

> **Step 1:** Add an `id` attribute to the target section:
> ```html
> <h2 id="contact">Contact Us</h2>
> <p>Our email: info@example.com</p>
> ```
>
> **Step 2:** Create a link using `#` followed by the `id` name:
> ```html
> <a href="#contact">Jump to Contact Section</a>
> ```
>
> When clicked, the page scrolls down to the element with `id="contact"`.

---

**Q4. Why should you use a `<ul>` with `<li>` elements for navigation menus instead of just writing links one after another?**

> Using `<ul>` with `<li>` for navigation is the professional standard because:
> 1. **Semantic meaning:** A menu IS a list of options — using a list correctly represents this
> 2. **Accessibility:** Screen readers announce "navigation with 5 items," helping visually impaired users understand the menu structure
> 3. **CSS styling:** Lists are much easier to style horizontally or vertically with CSS
> 4. **Code organization:** The code is cleaner, more readable, and maintainable
>
> ```html
...
**Q5. Write a nested list showing "Fruits" with sub-items (Apple, Banana) and "Vegetables" with sub-items (Carrot, Spinach) using proper HTML.**
...
> The nested `<ul>` is placed **inside** the parent `<li>`, not directly inside the outer `<ul>`. This follows the nesting rule: nested lists must always be children of `<li>` elements.
